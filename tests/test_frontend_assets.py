...
def test_login_page_exposes_auth_controls():
    ...
    assert "auth-form" in html, "Login page should render the authentication form"
    assert "auth-username" in html, "Username input must be present on the login page"
