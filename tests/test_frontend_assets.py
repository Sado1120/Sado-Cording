...
def test_frontend_html_declares_utf8_and_korean_fonts():
    ...
    assert "auth-overlay" in html, "Login overlay must be present to protect the dashboard"
    assert "auth-form" in html, "Authentication form should be rendered for secure access"
