...
def _fallback_recommendation_payloads(
    *,
    ...
    """Return deterministic recommendation placeholders for fallback scenarios."""
    ...
    *,
    ...
    if len(top_recommendations) < limit:
        ...
        fallback_candidates = _fallback_recommendation_payloads(
            ...
            exclude=[item.market for item in top_recommendations],
        )
        if fallback_candidates:
            top_recommendations.extend(fallback_candidates)
