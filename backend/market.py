...
_UPBIT_HTTP_TIMEOUT = _parse_positive_float_env("UPBIT_HTTP_TIMEOUT", 3.0)
_UPBIT_HTTP_ATTEMPTS = max(1, _parse_positive_int_env("UPBIT_HTTP_ATTEMPTS", 2))
...
def _request_upbit_alt(path: str, params: Optional[Dict[str, object]] = None) -> Any:
    ...
    attempts = max(1, min(2, _UPBIT_HTTP_ATTEMPTS))
    last_error: Optional[BaseException] = None
